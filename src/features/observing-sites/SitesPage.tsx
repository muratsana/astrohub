    ...
    <Container className="py-10 sm:py-14">
      <header className="mb-8">
        ...
        <p className="mt-2 max-w-xl text-muted-foreground">
          Türkiye'nin karanlık gökyüzü noktaları — Bortle/SQM ölçümleri, erişim
          ve tesis bilgileriyle.
        </p>
      </header>
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <div className="mt-auto flex flex-wrap gap-1.5 pt-4">
                  ...
                  {site.facilities.tentArea && <Badge tone="teal">Çadır</Badge>}
                  {site.facilities.caravanOk && <Badge tone="teal">Karavan</Badge>}
                </div>
              </div>
            </Link>
          </li>
