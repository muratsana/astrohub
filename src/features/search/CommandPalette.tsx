    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2.5 border-b border-border px-4">
          ...
          />
          <kbd className="hidden shrink-0 rounded-[2px] border border-border px-1.5 py-0.5 text-[9px] uppercase tracking-widest text-faint sm:block">
            Esc
          </kbd>
        </div>
                        ...
                        >
                          ...
                          <span className="min-w-0 flex-1">
                            <span className="flex items-center gap-2">
                              ...
                              {command.soon && (
                                <span className="shrink-0 rounded-[2px] border border-border px-1 text-[9px] uppercase tracking-widest text-faint">
                                  Yakında
                                </span>
                              )}
                            </span>
                          ...
                          {isActive && (
                            <span
                              aria-hidden
                              className="shrink-0 text-[10px] uppercase tracking-widest text-faint"
                            >
                              ↵
                            </span>
                          )}
        ...
        <div className="flex items-center gap-4 border-t border-border px-4 py-2 text-[10px] uppercase tracking-[0.14em] text-faint">
          <span>↑↓ gez</span>
          <span>↵ çalıştır</span>
          <span>esc kapat</span>
        </div>
