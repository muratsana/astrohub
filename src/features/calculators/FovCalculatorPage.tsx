...
export function FovCalculatorPage() {
  ...
  const valid = focalLength > 0 && pixelSize > 0 && sensorWidth > 0 && sensorHeight > 0;
          ...
          {!result ? (
            ...
            <div className="space-y-5">
              ...
              <p className="text-xs text-muted-foreground/70">
                Not: örnekleme değerlendirmesi tipik gökyüzü koşullarına (seeing
                ~2–4″) göredir; kesin ideal aralık gökyüzü kalitesine bağlıdır.
              </p>
            </div>
          )}
        </section>
