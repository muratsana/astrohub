import type { EquipmentModel } from './taxonomy';

/**
 * EKİPMAN KATALOĞU — tohum verisi (§8.3). Admin panelinden veritabanına
 * taşınır; `services/content/equipment` tablo doluysa onu kullanıyor.
 *
 * TAKSONOMİ BURADA DEĞİL, `taxonomy.ts`TE. Sebep ölçülmüş bir maliyet:
 * bu dosyadaki dizi ~80 kB ve etiket haritası için buraya uzanan her
 * modül onu da paketine alıyordu. Ayrıntı taxonomy.ts başında yazılı.
 *
 * Geriye dönük uyumluluk için taksonomi buradan da dışa veriliyor —
 * ama YENİ KOD taxonomy.ts'ten almalı; buradan alan her modül kataloğu
 * da yanında taşır.
 */
