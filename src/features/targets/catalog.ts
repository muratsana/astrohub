...
export const movingTargets: MovingRow[] = [
  ...
  { code: '1P/Halley', aliases: ['Halley'], kind: 'kuyruklu-yildiz', name: 'Halley Kuyruklu Yıldızı', window: 'Tarihsel kayıt ve 2061 dönüşü', focal: '50–800 mm', note: 'Arşiv kayıtları için klasik periyodik kuyruklu yıldız; güncel parlaklık takvimle doğrulanmalıdır.' },
  { code: '2P/Encke', aliases: ['Encke'], kind: 'kuyruklu-yildiz', name: 'Encke Kuyruklu Yıldızı', window: '3.3 yıllık kısa periyotlu dönüşler', focal: '200–1000 mm', note: 'Geniş alan yerine takip doğruluğu ve ephemeris güncelliği önemlidir.' },
  { code: '12P/Pons-Brooks', aliases: ['Pons-Brooks', '12P'], kind: 'kuyruklu-yildiz', name: 'Pons-Brooks Kuyruklu Yıldızı', window: '2024 geçişi ve arşiv kayıtları', focal: '135–800 mm' },
  { code: '13P/Olbers', aliases: ['Olbers', '13P'], kind: 'kuyruklu-yildiz', name: 'Olbers Kuyruklu Yıldızı', window: '2024 geçişi ve arşiv kayıtları', focal: '200–1000 mm' },
  { code: '46P/Wirtanen', aliases: ['Wirtanen', '46P'], kind: 'kuyruklu-yildiz', name: 'Wirtanen Kuyruklu Yıldızı', window: '5.4 yıllık dönüşler', focal: '135–800 mm' },
  { code: '67P/Churyumov-Gerasimenko', aliases: ['67P', 'Churyumov-Gerasimenko'], kind: 'kuyruklu-yildiz', name: 'Churyumov-Gerasimenko Kuyruklu Yıldızı', window: '6.4 yıllık dönüşler', focal: '400–1200 mm' },
  { code: '81P/Wild 2', aliases: ['Wild 2', '81P'], kind: 'kuyruklu-yildiz', name: 'Wild 2 Kuyruklu Yıldızı', window: '6.4 yıllık dönüşler', focal: '400–1200 mm' },
  { code: '96P/Machholz', aliases: ['Machholz', '96P'], kind: 'kuyruklu-yildiz', name: 'Machholz Kuyruklu Yıldızı', window: 'Güneşe yakın geçişlerde', focal: '200–1000 mm' },
  { code: '103P/Hartley 2', aliases: ['Hartley 2', '103P'], kind: 'kuyruklu-yildiz', name: 'Hartley 2 Kuyruklu Yıldızı', window: '6.5 yıllık dönüşler', focal: '200–1000 mm' },
  { code: '109P/Swift-Tuttle', aliases: ['Swift-Tuttle', '109P'], kind: 'kuyruklu-yildiz', name: 'Swift-Tuttle Kuyruklu Yıldızı', window: 'Perseid ana cismi; tarihsel katalog', focal: '400–1200 mm' },
  { code: 'C/2020 F3', aliases: ['NEOWISE', 'C/2020 F3 NEOWISE'], kind: 'kuyruklu-yildiz', name: 'NEOWISE Kuyruklu Yıldızı', window: '2020 geçişi ve arşiv kayıtları', focal: '50–600 mm', note: 'Geniş kuyruk yapısı nedeniyle kısa odaklı kadrajlarda güçlü arşiv hedefidir.' },
  { code: 'C/2022 E3', aliases: ['ZTF', 'ZTF-2023', 'C/2022 E3 ZTF'], kind: 'kuyruklu-yildiz', name: 'ZTF Kuyruklu Yıldızı', window: '2023 geçişi ve arşiv kayıtları', focal: '135–800 mm' },
  { code: 'C/2023 A3', aliases: ['Tsuchinshan-ATLAS', 'C/2023 A3 Tsuchinshan-ATLAS'], kind: 'kuyruklu-yildiz', name: 'Tsuchinshan-ATLAS Kuyruklu Yıldızı', window: '2024 geçişi ve arşiv kayıtları', focal: '50–600 mm' },
  { code: 'C/2023 P1', aliases: ['Nishimura', 'C/2023 P1 Nishimura'], kind: 'kuyruklu-yildiz', name: 'Nishimura Kuyruklu Yıldızı', window: '2023 geçişi ve arşiv kayıtları', focal: '135–800 mm' },
