            ...
            <ul className="flex flex-wrap gap-1.5">
              {primaryNav.map((item) => (
                <li key={item.to}>
                  <Link
                    to={item.to}
                    className="inline-block rounded-card border border-border px-2.5 py-1 text-[10px] uppercase tracking-[0.12em] text-muted-foreground transition-colors hover:border-border-strong hover:text-foreground"
                  >
                    {item.label}
                  </Link>
                </li>
